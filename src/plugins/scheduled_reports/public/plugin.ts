...
export class ScheduledReportsPlugin
  ...
  public setup(core: CoreSetup): ScheduledReportsPluginSetup {
    ...
    return {
      getGreeting() {
        return i18n.translate('scheduledReports.greetingText', {
  ...
  public start(core: CoreStart): ScheduledReportsPluginStart {
    return {};
  }
